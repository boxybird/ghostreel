    ...
    <div class="flex min-h-screen">
        ...
        <aside class="w-14 lg:w-64 bg-dark-surface border-r border-white/5 flex flex-col py-6 shrink-0">
            ...
            <nav class="flex-1 px-1 lg:px-4">
                <ul class="space-y-1">
                    <li>
                        <a href="{{ route('heatmap.index') }}" class="flex items-center gap-3 px-2 py-2 lg:px-3 lg:py-2.5 rounded-lg bg-white/10 text-neon-cyan">
                    ...
                    <li>
                        <a href="{{ route('popular.index') }}" class="flex items-center gap-3 px-2 py-2 lg:px-3 lg:py-2.5 rounded-lg text-text-muted hover:bg-white/5 hover:text-text-primary transition-colors">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <header class="sticky top-0 z-10 bg-dark-bg/80 backdrop-blur-xl border-b border-white/5 px-6 py-4">
                <div class="flex items-center justify-between">
                    ...
                    >
                        ...
                        <kbd class="hidden sm:inline-block text-xs text-text-muted bg-white/5 px-1.5 py-0.5 rounded">⌘K</kbd>
                    </button>
                </div>
