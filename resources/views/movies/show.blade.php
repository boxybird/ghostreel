                ...
                <div class="flex flex-col items-center gap-6">
                    ...
                    <div class="shrink-0">
                        @if($posterUrl)
                            <img
                                src="{{ $posterUrl }}"
                                alt="{{ $movie->title }}"
                                class="w-56 md:w-64 md:w-105 rounded-xl shadow-2xl shadow-black/50"
                            >
                        @else
                            <div class="w-56 md:w-64 md:w-105 aspect-[2/3] rounded-xl bg-dark-surface flex items-center justify-center">
                    ...
                    <div class="text-center">
                        ...
                        <div class="flex flex-wrap justify-center gap-4">
                            @include('heatmap.partials.movie-stats-today', ['clickCount' => $clickCount])
